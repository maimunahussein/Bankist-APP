...
//DOM MANIPULATION
//DISPLAY THESE MOVEMENTS IN THE APPLICATIOAN UI
...
movements.forEach(function(mov, i) {
  ...
  containerMovements.insertAdjacentHTML('afterbegin', displayContainer);
});
...
//  console.log( adult.length)
 ...
 console.log(average)
  // const addAll = adult.reduce((acc,cur)=>acc+cur,0);
  // console.log(average)
  // const averageHumanAge =addAll /  adult.length
